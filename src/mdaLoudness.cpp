...
float mdaLoudness::getParameter(VstInt32 index) { return programs[curProgram].param[index]; }
...
bool mdaLoudness::getProgramNameIndexed (VstInt32 category, VstInt32 index, char* name)
{
